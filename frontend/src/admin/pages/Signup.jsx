...
const Signup = () => {
  ...
  const [form, setForm] = useState({
    ...
    username: "",
    password: "",
    // role removed - will default to 'waiter' on backend
  });
  ...
  const handleRegister = async (e) => {
    ...
    setMessage("");
    try {
      // Role is not sent from frontend, backend will assign default role
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-100 to-indigo-200 flex items-center justify-center p-5 font-sans">
      <div className="w-full max-w-md bg-white rounded-3xl p-10 shadow-2xl border border-white/30">
        ...
        {/* Step 3: Registration Form (Role removed) */}
        {step === 3 && (
          <form onSubmit={handleRegister} className="space-y-4">
            ...
            />
            {/* Role selection removed - will default to 'waiter' */}
            <button
              type="submit"
